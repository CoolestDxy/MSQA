...
questionList=[]
with open('./data/MLPQ/question/fr-en/3-hop/r2r_en_fr_en_question_en','r',encoding='utf-8')as f:
    for line in f:
        if line=='\t\n':
            continue
        q=line.split('\t')[0]
...
for i in range(0,len(questionList)):
    ...
    #print(phrase)
    with open('./phrase/fr-en/3-hop/r2r_en_fr_en_question_en_phrase', 'a', encoding='utf-8')as file:
